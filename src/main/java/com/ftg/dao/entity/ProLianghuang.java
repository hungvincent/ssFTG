...
/**
 * ProLianghuang generated by hbm2java
 */
@Entity
@Table(name = "pro_lianghuang")
public class ProLianghuang implements java.io.Serializable {
	...
	private List<ProLianghuangType> lianghuangType;

	public ProLianghuang() {
	}

	public ProLianghuang(String sessions) {
		this.sessions = sessions;
	}

	public ProLianghuang(String sessions, String startRegDate, String endRegDate, Date createDate, Integer createUserId,
	...
	@Transient
	public List<ProLianghuangType> getLianghuangType() {
		return lianghuangType;
	}

	public void setLianghuangType(List<ProLianghuangType> lianghuangType) {
		this.lianghuangType = lianghuangType;
	}
}
