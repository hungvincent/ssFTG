...
/**
 * ProAnniversary generated by hbm2java
 */
@Entity
@Table(name = "pro_anniversary")
public class ProAnniversary implements java.io.Serializable {
	...
	private List<ProAnniversaryType> anniversaryType;

	public ProAnniversary() {
	}

	public ProAnniversary(String sessions) {
		this.sessions = sessions;
	}

	public ProAnniversary(String sessions, String startRegDate, String endRegDate, Date createDate,
	...
	@Transient
	public List<ProAnniversaryType> getAnniversaryType() {
		return anniversaryType;
	}

	public void setAnniversaryType(List<ProAnniversaryType> anniversaryType) {
