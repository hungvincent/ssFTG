...
/**
 * ProLight generated by hbm2java
 */
@Entity
@Table(name = "pro_light")
public class ProLight implements java.io.Serializable {
	...
	private List<ProLightType> lightType;

	public ProLight() {
	}

	public ProLight(String sessions) {
		this.sessions = sessions;
	}

	public ProLight(String sessions, String startRegDate, String endRegDate, Date createDate, Integer createUserId,
	...
	@Transient
	public List<ProLightType> getLightType() {
		return lightType;
	}

	public void setLightType(List<ProLightType> lightType) {
