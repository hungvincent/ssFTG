...
/**
 * ProGodStar generated by hbm2java
 */
@Entity
@Table(name = "pro_god_star")
public class ProGodStar implements java.io.Serializable {
	...
	private List<ProGodStarType> godStarType;

	public ProGodStar() {
	}

	public ProGodStar(String sessions) {
		this.sessions = sessions;
	}

	public ProGodStar(String sessions, String startRegDate, String endRegDate, Date createDate, Integer createUserId,
	...
	@Transient
	public List<ProGodStarType> getGodStarType() {
		return godStarType;
	}

	public void setGodStarType(List<ProGodStarType> godStarType) {
		this.godStarType = godStarType;
	}
}
