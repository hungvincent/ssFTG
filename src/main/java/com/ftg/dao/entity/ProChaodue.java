...
/**
 * ProChaodue generated by hbm2java
 */
@Entity
@Table(name = "pro_chaodue")
public class ProChaodue implements java.io.Serializable {
	...
	private List<ProChaodueType> chaodueType;

	public ProChaodue() {
	}

	public ProChaodue(String sessions) {
		this.sessions = sessions;
	}

	public ProChaodue(String sessions, String startRegDate, String endRegDate, Date createDate, Integer createUserId,
	...
	@Transient
	public List<ProChaodueType> getChaodueType() {
		return chaodueType;
	}

	public void setChaodueType(List<ProChaodueType> chaodueType) {
		this.chaodueType = chaodueType;
	}
