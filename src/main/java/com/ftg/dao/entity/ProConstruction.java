...
/**
 * ProConstruction generated by hbm2java
 */
@Entity
@Table(name = "pro_construction")
public class ProConstruction implements java.io.Serializable {
	...
	public ProConstruction() {
	}

	public ProConstruction(String summary, Integer price, Integer inventory, Integer quantity, String startRegDate, String endRegDate, 
