...
/**
 * ProPilgrimage generated by hbm2java
 */
@Entity
@Table(name = "pro_pilgrimage")
public class ProPilgrimage implements java.io.Serializable {
	...
	private List<ProPilgrimageType> pilgrimageType;

	public ProPilgrimage() {
	}

	public ProPilgrimage(String sessions) {
		this.sessions = sessions;
	}

	public ProPilgrimage(String sessions, String startRegDate, String endRegDate, Date createDate, Integer createUserId,
	...
	@Transient
	public List<ProPilgrimageType> getPilgrimageType() {
		return pilgrimageType;
	}

	public void setPilgrimageType(List<ProPilgrimageType> pilgrimageType) {
		this.pilgrimageType = pilgrimageType;
	}
