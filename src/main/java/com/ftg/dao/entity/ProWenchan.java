...
/**
 * ProWenchan generated by hbm2java
 */
@Entity
@Table(name = "pro_wenchan")
public class ProWenchan implements java.io.Serializable {
	...
	private List<ProWenchanType> wenchanType;

	public ProWenchan() {
	}

	public ProWenchan(String sessions) {
		this.sessions = sessions;
	}

	public ProWenchan(String sessions, String startRegDate, String endRegDate, Date createDate, Integer createUserId,
	...
	@Transient
	public List<ProWenchanType> getWenchanType() {
		return wenchanType;
	}

	public void setWenchanType(List<ProWenchanType> wenchanType) {
		this.wenchanType = wenchanType;
	}
}
