	...
	for (var key in json) {
		$('#jyTbl').append(
	        $('<tr class="dataRow"></tr>').append(
	            ...
	            $('<td style="text-align:center; vertical-align: middle;"></td>').html("<button type='button' class='btn btn-info btn-xs' onclick='updJieyuan(this);'>修改</button> ")
	        )
	    );
		//代入排序第一筆的種類
		if(cnt == 0){
	...
	for (var key in json) {
		$('#jypTbl').append(
	        $('<tr></tr>').append(
	            ...
	            $('<td style="text-align:center; vertical-align: middle;"></td>').html("<button type='button' class='btn btn-info btn-xs' onclick='updJieyuanPrice(this);'>修改</button> ")
	        )
	    );
	}
}
...
function addJieyuanRow(){
	...
	$('#jyTbl').append(
        $('<tr class="dataRow"></tr>').append(
            ...
            $('<td style="text-align:center; vertical-align: middle;"></td>').html("<button type='button' class='btn btn-info btn-xs' onclick='saveJieyuan(this);'>儲存</button>")
        )
    );
}
...
function addJieyuanPriceRow(){
	...
	$('#jypTbl').append(
        $('<tr></tr>').append(
            ...
            $('<td style="text-align:center; vertical-align: middle;"></td>').html("<button type='button' class='btn btn-info btn-xs' onclick='saveJieyuanPrice(this);'>儲存</button>")
        )
    );
}
...
function updJieyuan(obj){
    ...
    $td.eq(7).html("<button type='button' class='btn btn-info btn-xs' onclick='saveJieyuan(this);'>儲存</button>");
}
...
function updJieyuanPrice(obj){
    ...
    $td.eq(4).html("<button type='button' class='btn btn-info btn-xs' onclick='saveJieyuanPrice(this);'>儲存</button>")
}
				...
				<div style="height:600px; overflow-y:scroll;">
					...
					<tr style="line-height:35px; text-align:center; background-color:#F7F7F7; color:#333; font-weight:bold;">
						...
						<th style="text-align:center;">
							<button type="button" class="btn btn-info btn-xs" onclick="addJieyuanRow();">新增</button>
						</th>
					</tr>
					</table>
				</div>
			...
			<td style="width:38%;">
				<div style="height:600px; overflow-y:scroll;">
					...
					<tr style="line-height:35px; text-align:center; background-color:#F7F7F7; color:#333; font-weight:bold;">
						...
						<th style="text-align:center;">
							<button type="button" class="btn btn-info btn-xs" onclick="addJieyuanPriceRow();">新增</button>
						</th>
					</tr>
					</table>
				</div>
